...
/**
 * Created by Trang on 5/27/2017.
 */

public class ListSongHotFragment extends Fragment implements Mp3API.OnResponseJsonCallback, View.OnClickListener {
    ...
    public ListSongHotFragment(int id, String urlImage, String title) {
        this.idAlbum = id;
